...
class SpeciesDetailViewController: BaseViewController, Storyboarded, OverviewResourcePresentable {
    ...
    static func show(_ item: Species) {
        let vc = SpeciesDetailViewController.instantiate(of: .detail)
        vc.viewModel = SpeciesDetailViewModel(item: item)
